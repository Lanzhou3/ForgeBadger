...
> 2026-05-11 补充：Platform AI Copilot 第一版独立架构规格已确认，见 `docs/superpowers/specs/2026-05-11-platform-ai-copilot-design.md`；实施计划见 `docs/superpowers/plans/2026-05-11-platform-ai-copilot.md`。第一版定位为 provider-backed、read-heavy、approval-gated 的平台操作助手，不开放自主开发、自动 tmux 输入、任意 shell 或 Codex app-server prompt/turn 输入，当前状态为待按计划开发。
