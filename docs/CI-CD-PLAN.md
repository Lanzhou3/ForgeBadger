...
- Script-level smoke harness tests pass, including the trial feedback packet
  audit, draft generator, intake contract validator, and tokenless runbook
  diagnostics contract validator.
