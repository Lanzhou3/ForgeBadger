...
| v1.5 Feishu primary gate | The current primary Feishu release gate is `FEISHU-BOT-WS=Caveat`; real bot long-connection/WebSocket receive/reply/reconnect evidence clears it, while public webhook URL verification is optional compatibility evidence. | `docs/EXTERNAL-EVIDENCE-GATES.md`, `docs/TRIAL-CHECKLIST.md` |
